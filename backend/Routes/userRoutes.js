...
const { getMyProfile, searchUser, myFriends, getMyNotifications, myOnlineFriends, updateUnreadMessageCount} = require('../Controllers/userController');
...
router.route('/unread').patch(isAuthenticated, catchAsync(updateUnreadMessageCount));
