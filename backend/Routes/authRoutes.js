...
const {createUser, loginUser, logout, imageUploadTest} = require('../Controllers/authController');
...
router.route('/test').post(singleFileUpload, catchAsync(imageUploadTest))
